...
#check_system_storage(5)
# print("hi")
# name = "joe"
# address = id(name)
# print(address)
# How to play an online game with your PC
# 1. check the system requirement
# if the pc is above the system requirement
# continue 
# else upgrade your pc
# 1. download the game

# download_game("LoL")
# 2. registe yourself in the game website
# 3. install the game.
# 4. log into the game
# 5. play the game
#download_game("WoW")
# Game class which have two variables：the name of the game and the required storage of the game in size of Gigabytes
# class Game:
#     #Initialize an Game Object 
#     def __init__(self, name,required_storage):
#         self.name = name
#         self.required_storage = required_storage
    #print the game name with its required storage
    # def print_game(self):
    #     print(self.name + " requires " + self.required_storage + "GB storage")
